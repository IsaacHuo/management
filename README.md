...
一个简单的图书馆管理系统，采用 FastAPI 后端、SQLite 数据库、HTML/CSS/JS 管理后台、数据库初始化脚本和本机部署脚本。项目依赖运行使用 `uv` 管理。

## 功能

- 单管理员登录，默认账号：`admin`，默认密码：`123456`
...
打开 `http://127.0.0.1:8000`，使用用户名 `admin`、密码 `123456` 登录。
